...
$(function () {
    $(window).scroll(function () {
        0 == $(window).scrollTop() ? $("#go_top").stop(!1, !0).fadeOut(600) : $("#go_top").stop(!1, !0).fadeIn(600)
    ...
    $("a.breadcrumbLink:last-child").addClass("active_breadcrum");

    var n = $("#dnn_dnnBreadcrumb_lblBreadCrumb a:first").text();
    $("#MenuH .menu > .mi > .txt").each(function () {
        $(this).text() == n && $(this).parent().addClass("current")
    })
});